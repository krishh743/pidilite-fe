...
import ConfirmDeleteDialog from "../../Admin/add-users/ConfirmationBox";
...
const ActiveVariations = ({ setWindow, window }) => {
  ...
  const handleDeleteUser = async () => {
    try {
      ...
      toast.error("Variation deleted successfully!");
      setShowConfirmDelete(false);
    } catch (error) {
      console.error("Error Variation:", error);
      toast.error("Error while Variation user.");
    }
  };
  ...
  return (
    <div className="adminGamesListMain">
      ...
      <div className="setupPanel">
        <h3 className="trainingGamesHeader"> Setup</h3>

        <div className="panelBtns">
          <div className="LiveAndArchiveBtns">
            <button
              className={`${
                window === "activevariations" ? "openedWindow" : ""
              }`}
              onClick={() => handleChangeTab("activevariations")}
            >
              Active Variations
            </button>
            ...
            <button
              className={`${
                window === "archivesvariations" ? "openedWindow" : ""
              }`}
              onClick={() => handleChangeTab("archivesvariations")}
            >
              Archived Variations
            </button>
          </div>
          <div className="basicDetailsHeaderBtns">
            ...
            {/* <button className="saveButton cancel"   >ARCHIVE</button> */}
          </div>
        </div>
      </div>
      <div className="listAndDetailsContainer">
        <div className="listContainer">
          ...
          <table className="adminListTable" style={{margin:"0"}}>
            <thead>
            ...
            <tbody className="listTableBody">
              {gameListData?.map((game: gameOverview, index) => (
                <tr key={index}>
                  ...
                  <td className="viewColumn" style={{display:'flex',gap:10,justifyContent:"center"}}>
                    <img
                      className="openEye"
                  ...
                  <td> */}
                    <svg
                      ...
                      onClick={() => handleOpenConfirmDelete(game?.id)}
                    >
          ...
          <button
            className="addGameBtn saveButton"
...
export default ActiveVariations;
