...
const OngoingGames = ({ setWindow, window }) => {
    ...
    const fetchGamesList = async () => {
        try {
            const ongoingGamesResponse = await fetch(`${baseUri}/api/gameplay?status=1&status=2&status=3`, {
                method: 'GET',
                headers: {
            ...
            <div className="adminOngoingGamesBody">
                            ...
                            <div className="trainerSetupDetailsContainerCard">
                                ...
                                <div className="trainerSetupDetailsContainerCardBody">
                                    ...
                                    <div className="qrContainer">
                                        {gameId !== null && <QRCode value={`${appUrl}/game-play/${gameId}`} />}
                                    </div>
                ...
                <div className={`previewGameRightContainer ${previewedGame.id !== null ? '' : 'hidden'}`}>
                    ...
                    <div className="boardContainer">
                        ...
                        <button className={`fullScreenBtn ${gameId === null ? 'disabled' : ''}`} onClick={handleFullScreenSpectateGame}>OPEN GAME</button>
                    </div>
                </div>
            </div>
